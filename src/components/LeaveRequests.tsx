...
const LeaveRequests: React.FC = () => {
  // Mock data representing incoming leave requests from employees
  const requests: LeaveRequest[] = [
    { 
      id: 101, 
      employeeName: "Zoë Robins", 
  ...
  return (
    ...
    <section className="leave-requests-panel">
      <header className="panel-header">
        ...
        {/* Dynamic counter for pending requests */}
      ...
      <div className="requests-list">
        {/* Render the list of requests using map */}
        {requests.map((request) => (
          <div key={request.id} className="request-card">
            ...
            <div className="card-top">
              ...
              {/* Dynamic class for status color styling */}
